...
namespace TeddyShopWebApplication.Controllers
{
    ...
    public class CompañiaController : Controller
    {
        ...
        public CompañiaController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NIT,TelefonoEmpresa,NombreEmpresa,DIreccionEmpresa")] Compañia compañia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NIT,TelefonoEmpresa,NombreEmpresa,DIreccionEmpresa")] Compañia compañia)
        {
            if (id != compañia.NIT)
            {
                return NotFound();
