    ...
    public class MovimientosController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var movimiento = await _context.Movimientos
                ...
                .FirstOrDefaultAsync(m => m.Inventario_IdInventario == id);
            if (movimiento == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IdMovimiento,Fecha,CantidadIngreso,CantiidadVendida,Inventario_IdInventario")] Movimiento movimiento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMovimiento,Fecha,CantidadIngreso,CantiidadVendida,Inventario_IdInventario")] Movimiento movimiento)
        {
            if (id != movimiento.Inventario_IdInventario)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!MovimientoExists(movimiento.Inventario_IdInventario))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Movimientos.Any(e => e.Inventario_IdInventario == id);
        }
    }
}
