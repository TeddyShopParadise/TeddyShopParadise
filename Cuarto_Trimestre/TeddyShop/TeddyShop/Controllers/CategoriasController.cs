...
namespace TeddyShop.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,DescripcionCategoria,NombreCategoria")] Categoria categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,DescripcionCategoria,NombreCategoria")] Categoria categorium)
        {
